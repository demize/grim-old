...
static void print_welcome()
{
	...
	const char *line1 = "ewfimager " PACKAGE_VERSION;
	const char *line2 = "Visit our Github at github.com/demize/ewfimager.";
	const char *line3 = "Comments can be addressed to demize@unstable.systems.";
	const char *line4 = "";
	const char *line5 = "Press any key to continue.";
	int width = max_from_five(strlen(line1), strlen(line2), strlen(line3), strlen(line4), strlen(line5)) + 4;
	...
	WINDOW *border_win = create_window_border(height + 2, width + 2, starty - 1, startx - 1);
